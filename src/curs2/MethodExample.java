...
public class MethodExample {
	...
	int buctarie = room.calculateArea(5, 5);
	System.out.println(buctarie);
	
	System.out.println("------------------------");
	
	System.out.println(" Nr total :" + calculazaNrTotalMp(hol, buctarie, 12,10, 8));
	...
	/*public static int calculazaNrTotalMp(int room , int room2) {
		return room + room2;
	}*/
	
	public static int calculazaNrTotalMp(int...rooms) {
